...
This challenge looked extremely difficult to me at first glance and I tried to
solve it like 2 hours, after some blind brute forcing I inspected the source
code more careful, then I realized that require function was undefined, but
import wasn't. So I tried using import to import fs and read the flag.
...
It succeeded and I got the flag.
